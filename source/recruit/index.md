...
| ------------------------------------------------------------ | ------------------ | --------------------------- | ------------------------------------------------------------ | -------------- | ------------------- | ------- |
| Microsoft 365 Big Data and Compliance Engineering team       | Dev                |                             | Big data                                                     | Suzhou         | 1Y+                 | Middle  |
| Office Data Loader                                           | Dev                |                             | Big data                                                     | Suzhou         | 1Y+                 | Middle  |
| SRE for MMD                                                  | SRE                |                             |                                                              | Suzhou         | 3Y+                 | Strong  |
| M365 Cloud Security                                          | Dev                |                             | Security                                                     | Suzhou         | 1Y+                 | Middle  |
...
| Store                                                        | Dev/Data scientist |                             |                                                              | Suzhou         | 3Y+                 | Strong  |
| Performance team                                             | Dev/Data scientist |                             |                                                              | Suzhou         | 3Y+                 | Strong  |
...
| AD Team                                                      | Dev                |                             | Security                                                     | Suzhou         | 1Y+                 | Strong  |
| Outlook Mobile                                               | Dev                | Android/iOS                 |                                                              | Suzhou         | 1Y+                 | Middle  |
| Outlook Desktop                                              | Dev                | MacOS                       | iOS                                                          | Suzhou         | 3Y+                 | Strong  |
| Cloud validation framework                                   | Dev                |                             |                                                              | Suzhou         | 3Y+                 | Strong  |
| Cloud validation framework                                   | EM                 |                             |                                                              | Suzhou         | 10Y+                | Strong  |
| Elastic Storage Service                                      | EM                 |                             |                                                              | Suzhou         | 10Y+                | Strong  |
| Exchange Online Protection                                   | EM                 |                             |                                                              | Suzhou         | 10Y+                | Strong  |
| Templates & Verticals                                        | Dev                |                             | Frontend                                                     | Suzhou         | 3Y+                 | Strong  |
| Teams                                                        | Dev                | C++/Network/CV              |                                                              | Suzhou         | 5Y+                 | Strong  |
...
| Data platform, ODSP                                          | Dev                |                             |                                                              | Suzhou         | 3Y+                 | Strong  |
| MSAI                                                         | Dev                | Android/iOS                 |                                                              | Suzhou         | 2Y+                 | Low     |
| Edge Browser                                                 | Dev                |                             |                                                              | Suzhou         | 1Y+                 | Low     |
| Bing  search relevance/result ranking                        | Dev                | ML/DL                       |                                                              | Suzhou         | 1Y+                 | Low     |
| Bing WPO                                                     | Dev                | Fronted/Full stack          |                                                              | Suzhou         | 1Y+                 | Low     |
| Bing answers                                                 | Dev                |                             | Recommendation system                                        | Suzhou/Beijing | 3Y+                 | Low     |
| Ads campaign                                                 | Dev                | Frontend/Full stack         |                                                              | Suzhou/Beijing | 1Y+                 | Low     |
| WebXT Data                                                   | Dev                | Backend/Big data            | Data governance/Data model/Data quality                      | Suzhou/Beijing | 1Y+                 | Low     |
| Ads UCM                                                      | Dev                | Frontend/Backend/Full stack | Accounting/Billing/Payment                                   | Suzhou/Beijing | 1Y+                 | Low     |
| Index Serve Platform team                                    | Dev                | Backend                     | Resource Scheduling/Distributed Object Storage system/Index Selection/Ranking | Beijing        | 3Y+                 | Low     |
| Office extensibility                                         | Dev                |                             | Frontend/Backend/Full stack                                  | Beijing        | 1Y+                 | Low     |
| Ads Algo: User response prediction                           | Dev                |                             | Large scale machine learning algorithms/IR-based ad retrieval | Beijing        | 2Y+                 | Middle  |
| Azure Storage                                                | Dev                | C/C++                       | Cloud                                                        | Shanghai       | 3Y+                 | Strong  |
| MySQL (Database Service) on Azure, building the localized service | Dev                | C++                         | Database                                                     | Shanghai       | 2Y+                 | Middle  |
| Azure Data Catalog team                                      | Dev                |                             | Backend                                                      | Shanghai       | 1Y+                 | Middle  |
| Azure Date UX team                                           | Dev                |                             | Frontend                                                     | Shanghai       | 1Y+                 | Middle  |
| Jave on Azure                                                | Dev                | Java                        | Cloud/AI                                                     | Shanghai       | 1Y+                 | Middle  |
